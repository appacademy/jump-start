...
Codecademy link (complete this first if you haven't yet):
  ...
  * Write a function `capitalize(string)` that takes in a string, capitalizes the first letter of the string, and returns the string. Note: Do not use the built method `String#capitalize` 
