...
# ************************************
# Write a method that takes an array of numbers as input and returns an array of each element in times its position within the array.
...
puts redact_five_letter_words("one two three four five six seven eight") == "one two ##### four five six ##### eight"
